...
impl OpenAiModel {
    pub fn openai_backend_from_model_id(model_id: &str) -> OpenAiModel {
        match model_id {
            "gpt-4" => Self::gpt_4(),
    ...
    pub fn gpt_4_turbo() -> OpenAiModel {
        OpenAiModel {
    ...
    pub fn gpt_3_5_turbo() -> OpenAiModel {
        OpenAiModel {
